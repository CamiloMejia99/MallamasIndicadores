<?php
    ...
    if (empty($procesosSeleccionados)) {
        echo "<script>alert('Debe seleccionar al menos un proceso.'); window.location='vista_exportar_excel.php';</script>";
        exit;
    }
    ...
    if (empty($procesosValidos)) {
        echo "<script>alert('No tiene permisos para los procesos seleccionados.'); window.location='vista_exportar_excel.php';</script>";
        exit;
    }
    ...
    // -------------------------------------------------------------
    // 4. Filtro dinámico según rango de meses
    // -------------------------------------------------------------
    $filtroMes = '';
